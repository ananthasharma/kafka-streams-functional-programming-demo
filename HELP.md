...
* The original package name 'com.ananthasharma.apps.demo-cloud-streaming-with-kafka' is invalid and this project uses 'com.ananthasharma.apps.democloudstreamingwithkafka' instead.
